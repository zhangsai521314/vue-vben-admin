<template>
    <line_1 v-if="options.chartType == 'line_1'" :class="prefixCls" ref="chartRef" :chartOption="props.chartOption" :options="options" :dataInfo="dataInfo" :filterData="filterData" :filterDataNull="filterDataNull" />
    <bar_1 v-else-if="options.chartType == 'bar_1'" :class="prefixCls" ref="chartRef" :chartOption="props.chartOption" :options="options" :dataInfo="dataInfo" :filterData="filterData" :filterDataNull="filterDataNull" />
    <bar_2 v-else-if="options.chartType == 'bar_2'" :class="prefixCls" ref="chartRef" :chartOption="props.chartOption" :options="options" :dataInfo="dataInfo" :filterData="filterData" :filterDataNull="filterDataNull" />
    <yewei_1 v-else-if="options.chartType == 'yewei_1'" :class="prefixCls" ref="chartRef" :chartOption="props.chartOption" :options="options" :dataInfo="dataInfo" :filterData="filterData" :filterDataNull="filterDataNull" />
    <pie_1 v-else-if="options.chartType == 'pie_1'" :class="prefixCls" ref="chartRef" :chartOption="props.chartOption" :options="options" :dataInfo="dataInfo" :filterData="filterData" :filterDataNull="filterDataNull" />
    <yibiao_1 v-else-if="options.chartType == 'yibiao_1'" :class="prefixCls" ref="chartRef" :chartOption="props.chartOption" :options="options" :dataInfo="dataInfo" :filterData="filterData" :filterDataNull="filterDataNull" />
    <jindu_1 v-else-if="options.chartType == 'jindu_1'" :class="prefixCls" ref="chartRef" :chartOption="props.chartOption" :options="options" :dataInfo="dataInfo" :filterData="filterData" :filterDataNull="filterDataNull" />
</template>
<script setup>
...
function getDemoSource() {
    ...
    dataInfo.value = {
        source: data,
        tags: props.dataInfo.tags.length > 0 ? props.dataInfo.tags : [
            { tagid: "a", filtermin: null, filtermax: null, color: "#2ae891", tagname: "数据1", tagunit: "kg" },
            { tagid: "b", filtermin: null, filtermax: null, color: "#0cdaef", tagname: "数据2", tagunit: "°" },
            { tagid: "c", filtermin: null, filtermax: null, color: "#ef6b0d", tagname: "数据3", tagunit: "ml" }
        ]
...
function getSource() {
    ...
    return new Promise((res, rej) => {
        const tagIds = props.dataInfo.tags.map((m => { return m.tagid }));
        if (tagIds.length > 0) {
            const newTime = dayjs();
            let startTime = newTime.subtract(props.options.timeFrequency, props.options.timeInterval).format('YYYY-MM-DD HH:mm:ss');
            ...
            commonApi.Request(props.options.getSourceUrl, {
                startTime,
                endTime,
                tagIds,
            }).then((data) => {
