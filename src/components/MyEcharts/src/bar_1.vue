...
const { prefixCls } = useDesign('charts-bar2');
const { getInstance, resize, echarts, dispose } = useECharts(chartRef);
...
@prefix-cls: ~'@{namespace}-charts-bar2';
