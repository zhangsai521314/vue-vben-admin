...
function definition() {
  ...
  if (!connection || connection._connectionState != "Connected" ||
    (props.signalRConfig.withurl != "" && connection.connection.baseUrl != props.signalRConfig.withurl) ||
  ...
  //成功消息
  if (isInitial || (signalRConfig.success && signalRConfig.success != props.signalRConfig.success)) {
