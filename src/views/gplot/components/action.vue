<template >
    ...
    <template v-if="props.item.event != 'rightClick' && props.item.type == 'open_url'">
        ...
        <template v-if="props.item.openurl.target == 'page_alert'">
            ...
            <div class="content-item">
                <div>
                    <a-input-number style="width: calc((100% - 13.5px) / 2);" v-model:value="props.item.openurl.width" :min="props.item.openurl.sizeUit == 'px' ? 600 : 10" addon-after="宽" size="small" />
                    -
                    <a-input-number style="width: calc((100% - 13.5px) / 2);" v-model:value="props.item.openurl.height" :min="props.item.openurl.sizeUit == 'px' ? 500 : 10" addon-after="高" size="small" />
                </div>
            </div>
        </template>
        ...
        <div class="content-item">
            ...
            <div>
                <a-input :disabled="props.item.openurl.urlType == 'inside'" v-model:value="props.item.openurl.url" size="small" style="width: 180px" />
            </div>
        </div>
    </template>
    <template v-else-if="props.item.event != 'rightClick' && props.item.type == 'instructions'">
        <div class="content-item">
            ...
            <div>
                <a-select v-model:value="props.item.instructions.instructions_type" style="width: 120px" size="small">
        ...
        <div class="content-item" v-show="props.item.instructions.instructions_type == 'fixed'">
            ...
            <div>
                <a-input v-model:value="props.item.instructions.fixed_value" style="width: 120px" size="small" />
            </div>
        </div>
        <div class="content-item" v-show="props.item.instructions.instructions_type == 'bool'">
            <div>
                <a-input style="width: calc((100% - 17px) / 2);" v-model:value="props.item.instructions.open_value" addon-after="开值" size="small" />
                <a-tooltip>
                    <template #title>
                ...
                <a-input style="width: calc((100% - 17px) / 2);" v-model:value="props.item.instructions.close_value" addon-after="关值" size="small" />
            </div>
        </div>
        <div class="content-item" v-show="props.item.instructions.instructions_type == 'custom'" style="color:red">
    ...
    <template v-if="props.item.event != 'rightClick' && props.item.type == 'request_url'">
        <div class="content-item">
            ...
            <div>
                <a-select v-model:value="props.item.requesturl.reques_type" style="width: 120px" size="small">
